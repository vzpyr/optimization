...
echo.       %f%%w%             ###        ###    ### ########## ###       ### ###########  ########  ###       ### 
echo.       %f%%w%                                              
echo.       %f%%w%                                               %p%𝐁𝐎𝐎𝐒𝐓 𝐔𝐓𝐈𝐋𝐈𝐓𝐘
echo.       %f%%w%     
echo.       %f%%w% ----------------------------------------------------------------------------------------------------------------
echo.       %f%%w%
echo.       %f%%w%                                              VERSION 1.0.0
echo.       %f%%w%                                                                                                                  %f%
echo.       %f%%w%                                          %b%made by $=life and moh
echo.       %f%%w%                                     %b%For More Tweaks discord.gg/mohistkn                                          %b%
echo.       %f%%w%                                                                                                                  %f%
echo.       %f%%f%
echo.       %f%%w%                                                                                                                  %f%
...
echo.       %f%%w%                                  
echo.       %f%%w%                                  
echo.       %f%%w%                                         %f%Last Update: 11/17/23
...
if /i %input% == o start https://discord.gg/mohistkn
...
echo.
echo.                        %f%""%w%
echo.                                         Priority Tweaks (select game)
echo.                                                      
echo.
echo.
echo.                                                  %f%[1]%w% Fortnite     %f%[2]%w% Valorant
echo.
echo.
...
:: Fortnite Priority 
echo Fortnite Priority (its a lot more detailed in my premium utility)
...
:val 
echo valorant Priority (its a lot more detailed in my premium utility)
...
curl -g -k -L -# -o "C:\Users\hungr\OneDrive\Desktop\moh\autoruns.exe" "https://cdn.discordapp.com/attachments/1171238460451991617/1171238528793972766/autoruns.exe?ex=655bf3e1&is=65497ee1&hm=38d8e16aa9b8015960949f70a42b22f396ec4cea47e816011a43d0eff8868ee9&"


powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('After you press ok it will open an app, Go to the LOGON section, disable all services except: antivirus, cmd.exe, and the n/a services', 'Moh Tweaking Panel', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul

start C:\Users\hungr\OneDrive\Desktop\moh\autoruns.exe
echo.
echo.
echo.
echo.                                              %f%
